...
const Navbar = () => {
  ...
  const categories = {
    ...
    'WOMEN': [
      {
        title:'Topwear',
        items: ['Top','T-Shirt','Formal Shirt','Jackets','Sweaters','Dresses']
      },
      {
        title:'Indian & Festive Wear',
        items: ['Kurtas & Suits',' Kurtis','Sarees',
       'Tunics & Tops','Ethnic Wear','Salwars & Churidars','Skirts & Palazzos','Lehenga Cholis','Dupattas & Shawls']
      },
      {
        title:'Bottomwear',
        items:['jeans','Shorts & Skirts','Playsuits','Jumpsuits']
      }
    ],
    'KIDS': [
      {
  ...
  return (
    <Box sx={{ position: 'sticky', top: 0, zIndex: 1200 }}>
      ...
      <nav className="flex items-baseline justify-between px-4 py-2 shadow-md bg-white">
        {/* Left: Logo with tight spacing */}
        <div className="flex items-baseline">
          <div className="text-pink-500 text-2xl font-bold " style={{ letterSpacing: '1px' }}>
            MYNTRA
          </div>
          
          {/* Categories with negative spacing */}
